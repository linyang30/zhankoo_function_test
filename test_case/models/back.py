...
class Back:
    ...
    back_ticket_list_url = 'http://back.zhankoo.com/Exhibition/Ticket/TicketFindPaged'
    back_ticket_del_url = 'http://back.zhankoo.com/Exhibition/Ticket/TicketDelete'
    headers = {
